// Theme toggle — INU LAB product page
(function () {
...
// Reveal on scroll + animate spec bars
(function () {
  ...
  document.querySelectorAll('.num, .benefit-card, .proof-item, .spec-table tr').forEach((el) => io.observe(el));
})();
